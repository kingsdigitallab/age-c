...
1. Overview – View broad patterns and visual insights across the entire dataset.  
2. Search – Check whether a specific film or person is included; best for quick lookups.  
3. Filters – Combine multiple filters for in-depth exploration.  
...
1. Main category (e.g., Genre, Production country, Role, Release year, Awards)  
2. Group by (compare sub-groups, e.g., Gender, Country)  
3. Chart type (Bar, Pie, Line, etc.)  
...
Does filmmaker Pedro Almodóvar appear in the dataset?  
Is the film *I, Daniel Blake* included?

### How to use
1. Enter at least three characters (film title, person name, or keyword) in the search box.  
2. Select what you want to search in: Full text, Titles, or Names.  
3. Click Search or press Enter to display results.  
