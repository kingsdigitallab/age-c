...
Learn more on the [AGE-C Project Website](https://www.age-c.eu).
...
For full definitions of filters and tags, and details on how the dataset was created, visit the [Glossary](https://kingsdigitallab.github.io/age-c/glossary).

You can also download the full dataset for further analysis via the [MediaRep repository](https://mediarep.org/entities/dataset/ac3c101b-08e8-4930-bdfe-36afe2c2bc5c).

A methodological overview and academic publications resulting from the AGE-C project will be made available on the [AGE-C Project Website](https://www.age-c.eu).
...
Contact the AGE-C team at [gepper@tfm.uni-frankfurt.de](mailto:gepper@tfm.uni-frankfurt.de)
